        ...
        <thead>
          <tr>
            ...
            if($form_fields && $submit_id) {
              ...
              echo '>';
              if($ordering)
              echo '<a href="" onclick="document.getElementById(\'order_by\').value = \'group_id\'; document.getElementById(\'asc_or_desc\').value = \'' . (($order_by == "group_id" && $asc_or_desc == 'asc') ? 'desc' : 'asc') . '\'; spider_form_submit(event, \'adminForm\');">
                  <span>Id</span>
            ...
            if($submit_date) {
              ...
              echo '>';
              if($ordering)
              echo '<a href="" onclick="document.getElementById(\'order_by\').value = \'date\'; document.getElementById(\'asc_or_desc\').value = \'' . (($order_by == "date" && $asc_or_desc == 'asc') ? 'desc' : 'asc') . '\'; spider_form_submit(event, \'adminForm\');">
            ...
            if($submitter_ip) {
              ...
              echo '>';
              if($ordering)
              echo '<a href="" onclick="document.getElementById(\'order_by\').value = \'ip\'; document.getElementById(\'asc_or_desc\').value = \'' . (($order_by == "ip" && $asc_or_desc == 'asc') ? 'desc' : 'asc') . '\'; spider_form_submit(event, \'adminForm\');">
            ...
            if($username) {
              ...
              echo '>';
              if($ordering)
              echo '<a href="" onclick="document.getElementById(\'order_by\').value = \'display_name\'; document.getElementById(\'asc_or_desc\').value = \'' . (($order_by == "display_name" && $asc_or_desc == 'asc') ? 'desc' : 'asc') . '\'; spider_form_submit(event, \'adminForm\');">
            ...
            if($useremail) {
              ...
              echo '>';
              if($ordering)
              echo '<a href="" onclick="document.getElementById(\'order_by\').value = \'user_email\'; document.getElementById(\'asc_or_desc\').value = \'' . (($order_by == "user_email" && $asc_or_desc == 'asc') ? 'desc' : 'asc') . '\'; spider_form_submit(event, \'adminForm\');">
            ...
            for($i=0; $i < count($labels) ; $i++) {
              if($form_fields && !in_array($labels_id[$i], $checked_ids)) {
                ...
                if($ordering)
                echo '<a href="" onclick="document.getElementById(\'order_by\').value = \'' . $labels_id[$i] . '_field\'; document.getElementById(\'asc_or_desc\').value = \'' . (($order_by == $labels_id[$i] . '_field' && $asc_or_desc == 'asc') ? 'desc' : 'asc') . '\'; spider_form_submit(event, \'adminForm\');">
