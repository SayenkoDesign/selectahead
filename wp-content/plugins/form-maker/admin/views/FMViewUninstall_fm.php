...
class FMViewUninstall_fm {
          ...
          <tr>
            <td valign="top">
              <ol>
                  ...
                  <li><?php echo $prefix; ?>formmaker_mailchimp</li>
                  <li><?php echo $prefix; ?>formmaker_reg</li>
                  <li><?php echo $prefix; ?>formmaker_post_gen_options</li>
                  <li><?php echo $prefix; ?>formmaker_email_conditions</li>
                  <li><?php echo $prefix; ?>formmaker_dbox_int</li>
              </ol>
            </td>
          </tr>
        </table>
  ...
  public function uninstall() {
    ...
    <div id="message" class="updated fade">
        ...
        <p><?php echo $prefix; ?>formmaker_mailchimp</p>
        <p><?php echo $prefix; ?>formmaker_reg</p>
        <p><?php echo $prefix; ?>formmaker_post_gen_options</p>
        <p><?php echo $prefix; ?>formmaker_email_conditions</p>
        <p><?php echo $prefix; ?>formmaker_dbox_int</p>
    </div>
    <div class="wrap">
      <h2>Uninstall Form Maker</h2>
