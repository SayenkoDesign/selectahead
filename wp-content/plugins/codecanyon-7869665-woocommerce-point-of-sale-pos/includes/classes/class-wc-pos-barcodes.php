									...
									<table id="barcode_options">
										<tbody>
											...
											<tr class="form-field form-required">
												...
												<td>
														<select id="label_type"  style="width: 349px;" name="label_type">
							...
							<div class="postbox ">
								...
								<div class="inside" id="barcode_preview">
									<div class="barcode_border">
										<img src="<?php echo  plugins_url( 'barcode/image.php?filetype=PNG&dpi=72&scale=2&rotation=0&font_family=Arial.ttf&font_size=12&thickness=30&start=NULL&code=BCGcode128&text=111111111' , __FILE__ ) ?>" alt="">
