...
class WC_Pos_Grids_Table extends WP_List_Table {
  private static $data;
  ...
  global $status, $page;
      ...
      parent::__construct( array(
          'singular'  => __( 'grid-table', 'wc_point_of_sale' ),     //singular name of the listed records
          'plural'    => __( 'grids-table', 'wc_point_of_sale' ),   //plural name of the listed records
  ...
  function column_layouts_name( $item ) {
    $actions = array(
      'edit'      => sprintf('<a href="?page=%s&edit=%s">Edit</a>','wc_pos_grids', $item['ID']),
      'delete'      => sprintf('<a class="delete" href="?page=%s&delete=%s">Delete</a>','wc_pos_grids', $item['ID']),
    );
