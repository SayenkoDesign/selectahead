...
class WC_Pos_Receipts_Table extends WP_List_Table {
  private static $data;
  ...
  global $status, $page;
      ...
      parent::__construct( array(
          'singular'  => __( 'receipts_table', 'wc_point_of_sale' ),     //singular name of the listed records
          'plural'    => __( 'receipts_tables', 'wc_point_of_sale' ),   //plural name of the listed records
  ...
  function column_name_receipt( $item ) {
    $actions = array(
      'edit'      => sprintf('<a href="?page=%s&action=%s&id=%s">Edit</a>','wc_pos_receipts', 'edit', $item['ID']),
      'delete'      => sprintf('<a href="?page=%s&action=%s&id=%s">Delete</a>','wc_pos_receipts', 'delete', $item['ID']),
    );
