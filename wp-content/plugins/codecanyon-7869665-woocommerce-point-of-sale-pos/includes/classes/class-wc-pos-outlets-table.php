...
class WC_Pos_Outlets_Table extends WP_List_Table {
  private static $data;
  ...
  global $status, $page;
      ...
      parent::__construct( array(
          'singular'  => __( 'outlets_table', 'wc_point_of_sale' ),     //singular name of the listed records
          'plural'    => __( 'outlets_tables', 'wc_point_of_sale' ),   //plural name of the listed records
  ...
  function column_name( $item ) {
    $actions = array(
      'edit'      => sprintf('<a href="?page=%s&action=%s&id=%s">Edit</a>','wc_pos_outlets','edit', $item['ID']),
      'delete'      => sprintf('<a href="?page=%s&action=%s&id=%s">Delete</a>','wc_pos_outlets','delete', $item['ID']),
    );
  ...
  function column_contact( $item ) {
    ...
    WC_Pos_Outlets::init_form_fields();
    $social = WC_Pos_Outlets::$outlet_social_fields;
    $contact = WC_Pos_Outlets::$outlet_contact_fields;
