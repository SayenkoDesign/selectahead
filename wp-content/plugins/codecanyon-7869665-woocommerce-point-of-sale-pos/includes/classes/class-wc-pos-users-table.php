...
$GLOBALS['hook_suffix'] = '';
class WC_Pos_Users_Table extends WP_List_Table {
  private static $data;
  ...
  global $status, $page;
      ...
      parent::__construct( array(
          'singular'  => __( 'users_table', 'wc_point_of_sale' ),     //singular name of the listed records
          'plural'    => __( 'users_tables', 'wc_point_of_sale' ),   //plural name of the listed records
  ...
  function no_items() {
    _e( 'Users not found.', 'wc_point_of_sale' );
  }
