...
if ( ! class_exists( 'WC_POS_Settings_Tax' ) ) :

/**
 * WC_POS_Settings_General
 */
class WC_POS_Settings_Tax extends WC_Settings_Page {
		...
		if($enable_taxes != 'yes'){
			...
			$tax_based_on = array(
					...
					'options' => array(
							...
							'base'     => __( 'Shop address', 'wc_point_of_sale' ),
...
return new WC_POS_Settings_Tax();
