    ...
    public function init_form_fields() {
    	...
    	$this->form_fields  = array(
		    ...
		    'api'           => array(
				...
				'type'            => 'title',
				'description'     => __( 'You can obtaining a USPS user ID by signing up via their website, or just use ours. This is optional.', 'woocommerce-shipping-usps' ),
		    ),
		    'user_id'           => array(
		    ...
		    'enable_flat_rate_boxes'  => array(
				...
				'default'         => 'yes',
				'options'         => array(
					'yes'         => __( 'Yes - Enable flat rate boxes', 'woocommerce-shipping-usps' ),
					'no'          => __( 'No - Disable flat rate boxes', 'woocommerce-shipping-usps' ),
					'priority'    => __( 'Enable Priority flat rate boxes only', 'woocommerce-shipping-usps' ),
					'express'     => __( 'Enable Express flat rate boxes only', 'woocommerce-shipping-usps' ),
				),
				'description'     => __( 'Enable this option to offer shipping using USPS Flat Rate boxes. Items will be packed into the boxes and the customer will be offered a single rate from these.', 'woocommerce-shipping-usps' )
			),
			'flat_rate_express_title'           => array(
				'title'           => __( 'Express Flat Rate Box Name', 'woocommerce-shipping-usps' ),
				'type'            => 'text',
				'description'     => '',
				'default'         => '',
		    ...
		    'flat_rate_priority_title'           => array(
				'title'           => __( 'Priority Flat Rate Box Name', 'woocommerce-shipping-usps' ),
				'type'            => 'text',
				'description'     => '',
				'default'         => '',
