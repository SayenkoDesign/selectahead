...
SV_WC_Framework_Bootstrap::instance()->register_plugin( '4.0.0', __( 'WooCommerce Elavon VM Gateway', 'woocommerce-gateway-elavon' ), __FILE__, 'init_woocommerce_gateway_elavon', array( 'minimum_wc_version' => '2.2', 'backwards_compatible' => '4.0.0' ) );
