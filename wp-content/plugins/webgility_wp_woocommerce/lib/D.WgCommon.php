...
class WgCommon
{
	...
	//	$request = 	$this->getRequestData($_POST['request']);
		$request = 	$this->getRequestData($_POST['request']);
		//$request = '{"datefrom":"09-18-2012","start_order_no":"227","ecc_excl_list":"\u0027pending\u0027,\u0027failed\u0027,\u0027on-hold\u0027,\u0027processing\u0027,\u0027completed\u0027,\u0027refunded\u0027,\u0027cancelled\u0027","order_per_response":"10","LastModifiedDate":"01-18-2013 13:05:56","others":{"MaxOrderNoInBatch":"227","optionAsItem":false,"optionAsItemBundled":false,"optionAsItemConfigurable":false,"discountAsItem":false,"CCDetails":""},"method":"getOrders","username":"woocommerce","password":"wcuser","storeid":0,"version":"","ShouldCompress":true,"IsHtAccess":false,"SecureUserID":"","SecurePassword":""}';
		if($request)
		{
		...
		if(!empty($method))
		{
			switch ($method)
			{
				...
				// echo $str =$this->$method($username,$password,$start,$limit,$datefrom,$storeid,$others);
				break;
				...
				$method ='getOrders';	
				echo $str = $this->$method($username,$password,$datefrom,$start_order_no,$ecc_excl_list,$order_per_response,$LastModifiedDate,$storeid,$SelectedOrders,$others['CCDetails'],$others['MaxOrderNoInBatch']);
